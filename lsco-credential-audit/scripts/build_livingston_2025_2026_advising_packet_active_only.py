...
ACTIVE_ACADEMIC_YEAR_LABEL = "2024-2025"
...
MAJOR_MAP = {
    ...
    "ASPM": {"keywords": ["MEDICAL PROFESSIONS"], "prefer_hours": 60},
    "ASPE": {"keywords": ["PHYSICAL EDUCATION"], "prefer_hours": 60},
    "ASCI": {"keywords": ["SCIENCE"], "prefer_hours": 60},
    "AAT1": {"keywords": ["TEACHING"], "prefer_hours": 60},
    "AAT2": {"keywords": ["TEACHING"], "prefer_hours": 60},
    "AATP": {"keywords": ["TEACHING"], "prefer_hours": 60},
    "RNSG": {"keywords": ["REGISTERED NURSING", "NURSING"], "prefer_hours": 60},
    "RNAD": {"keywords": ["REGISTERED NURSING", "NURSING"], "prefer_hours": 60},
    "VNSG": {"keywords": ["VOCATIONAL NURSING"], "prefer_hours": 42},
    "PNUR": {"keywords": ["VOCATIONAL NURSING"], "prefer_hours": 42},
...
term_text = livingston_history["term_taken"].fillna("").str.upper()
active_term_mask = pd.Series(False, index=livingston_history.index)
for pattern in ACTIVE_TERM_PATTERNS:
    active_term_mask |= term_text.str.contains(pattern, regex=False)
...
if livingston_history.empty:
    ...
    raise RuntimeError(
        "No Livingston rows found. Most common high_school values:\n"
        + available.to_string()
    )
...
with pd.ExcelWriter(WORKBOOK_PATH, engine="xlsxwriter") as writer:
    ...
    for student in student_plan.sort_values(
        ...
        ws.write_row("A4", ["Student Planning Profile", ""], section_fmt)
        row_cursor = 4
