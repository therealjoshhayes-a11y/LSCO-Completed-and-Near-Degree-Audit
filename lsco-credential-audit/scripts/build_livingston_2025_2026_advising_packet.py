...
print(f"Livingston students: {len(cohort):,}")
...
with pd.ExcelWriter(WORKBOOK_PATH, engine="xlsxwriter") as writer:
    ...
    cover.write("A4", "Planning population", section_fmt)
...
print("=" * 110)
print(f"Students in cohort: {len(cohort):,}")
...
RUN_LOG.write_text(
    "\n".join(
        [
            ...
            f"Students in cohort: {len(cohort):,}",
